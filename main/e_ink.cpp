...
void e_ink::init_gpio()
{
	...
	ESP_ERROR_CHECK(gpio_isr_handler_add(BUSY_PIN, isr_handler, this));
}
...
void inline e_ink::send_byte(uint8_t b)
{
...
void inline e_ink::isr_busy_handler()
{
